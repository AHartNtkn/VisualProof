...
- [ ] Round 2b — the spawn browser (own design project per user ruling): hierarchical/searchable creation surface for terms + thousands of relations; trigger must coexist with selection (no empty-click dependence); variants to demo.
