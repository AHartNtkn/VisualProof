...
- [ ] **Step 1: Write failing cursor-history tests**
...
- [ ] **Step 3: Replace destructive side and track state**
...
- [ ] **Step 4: Migrate semantic consumers and existing tests**
...
- [ ] **Step 5: Verify pure session semantics and types**
...
- [ ] **Step 6: Commit the cursor authority**
...
- [ ] **Step 3: Implement semantic focus derivation**
...
- [ ] **Step 1: Write failing pure scrubber helper tests**
...
- [ ] **Step 3: Implement the component and pure helpers**
...
- [ ] **Step 1: Write failing browser assertions for production chrome**
...
- [ ] **Step 2: Verify the focused browser test fails**
...
- [ ] **Step 3: Build production Compass DOM and styling**
...
- [ ] **Step 4: Replace shell generic rows with Compass lifecycle ownership**
...
- [ ] **Step 5: Connect authoritative timelines and replay**
...
- [ ] **Step 6: Preserve the fixed-side boundary honestly**
...
- [ ] **Step 7: Verify relevant production UI behavior**
...
- [ ] **Step 1: Prove the old model is absent**
...
- [ ] **Step 2: Run the focused non-physics validation set**
...
- [ ] **Step 3: Update durable tracking and append conformance**
...
- [ ] **Step 4: Commit the completion receipt**
