...
- [ ] **Step 1: Write failing preference/frame tests**
...
- [ ] **Step 3: Write failing overlay/easing tests**
...
- [ ] **Step 6: Verify coordinator and existing morph laws**

  Run: `npx vitest run tests/app/motion.test.ts tests/view/morph.test.ts`

  Run: `npm run typecheck`

- [ ] **Step 7: Commit the motion authority**
...
- [ ] **Step 1: Write failing input-admission tests**
...
- [ ] **Step 3: Add the narrow viewport guard**
...
- [ ] **Step 4: Integrate motion into `ProofFrontViewport`**
...
- [ ] **Step 5: Guard the shared fixed-side session**
...
- [ ] **Step 6: Add failing then green fixed-front browser coverage**
...
- [ ] **Step 1: Write failing main production browser coverage**
...
- [ ] **Step 3: Prepare main proof commits before playback**
...
- [ ] **Step 4: Integrate structural overlays and hover easing**
...
- [ ] **Step 5: Guard main input and history**
...
- [ ] **Step 6: Build the Compass motion controls**
...
- [ ] **Step 7: Verify production motion behavior**
...
- [ ] **Step 1: Prove prohibited models are absent**
