...
Task 15: fix round 1/5 (3 open — retain and compare normalized reference/application stroke-junction trajectories and destinations; assert redex/argument/copy/base neutralization with Lambda-specific raster evidence; derive 3D structural/color evidence from the actual presented WebGL entities rather than a parallel motion sample; review commit 72eed266)
Task 15: fix round 1/5 (1 addressed, 3 open — exact presented WebGL provenance addressed; full curve geometry still admits zero-length app copy bars, per-stroke raster colors are aggregated, and reference raster tubes duplicate authority mapping/padding while omitting tickScale; commits b7aadf26..2cc53ba1)
Task 15: fix round 2/5 (3 open — restore/reference-check visible full copy-bar geometry; require independent eligible stroke/group raster color evidence; instrument live reference-painted paths instead of reimplementing its mapping)
Task 15: fix round 2/5 (1 addressed, 3 open — live Painter/context path instrumentation addressed; curve acceptance admits a 25.9%-of-reference collapsed bar and skips multi-piece interiors; overlap/occlusion is width-blind; light 3D Lambda restoration can overdraw pips; commits 2c05404d..d3b3b19d)
Task 15: fix round 3/5 (3 open — tight semantic-frame full-curve comparison for single/multi-piece groups; full painted-tube containment with member widths/minimal occluders; restore pips after Lambda in both 3D themes)
Task 15: fix round 3/5 (3 addressed, 1 open — tight full-curve/interior bounds, full-width tube occlusion, and both-theme pip restoration addressed; WebGL per-component normalization does not anchor rendered entity points to semantic junctionPoints, so a 40px curve translation passes; commits f6603499..6ea7b777)
Task 15: fix round 4/5 (1 open — bind every rendered WebGL curve endpoint/interior frame to its actual semantic junction placement and reject translated-curve counterexamples)
