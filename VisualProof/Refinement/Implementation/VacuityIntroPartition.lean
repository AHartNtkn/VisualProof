...
namespace VisualProof.Refinement.Implementation.VacuityIntroPartition
...
private theorem selectedOccurrences_eq_canonical
  ...
  unfold selectedOccurrences canonicalSelectedOccurrences
    Concrete.Elaboration.localOccurrences occurrenceSelected
    filterFin
...
theorem bubble_localOccurrences
    ...
    Concrete.Elaboration.localOccurrences
      ...
      (selectedOccurrences input selection).map
...
theorem anchor_localOccurrences
    ...
    Concrete.Elaboration.localOccurrences
      ...
      (keptOccurrences input selection).map
...
theorem anchorOccurrences_perm_partition
  ...
  simpa only [keptOccurrences,
    selectedOccurrences, Bool.not_not] using
    (List.filter_append_perm
      (fun occurrence =>
        !(occurrenceSelected selection occurrence))
...
end VisualProof.Refinement.Implementation.VacuityIntroPartition
