...
inductive FrameRouteAlignment {input : Input }
  ...
  | step
      ...
      {sourcePositionEq : indexOf? (Elaboration.localOccurrences
      ...
      {targetPositionEq : indexOf? (Elaboration.localOccurrences
