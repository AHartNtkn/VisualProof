...
/--
A diagnostic snapshot of raw map images. Observational equality is defined
later by reconstructed checked
...
/-- Decide the validity of a fully supplied raw occurrence certificate. -/
