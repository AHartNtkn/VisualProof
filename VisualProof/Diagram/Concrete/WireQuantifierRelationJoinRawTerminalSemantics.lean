...
/--
The raw relation join denotes in the direction selected by the source dying
site's cut parity.  The replacement relation is evaluated at the final
retained parameter values produced by the disintegrated construction.
-/
