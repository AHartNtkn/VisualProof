...
therefore create an identity; exact aliases create no node. This construction
owns the exact generated identity nodes required by the attachment.
-/
...
identities as one direct generated table.
-/
def diagram
    {definitions : List (List Sig)}
    {base : CheckedDiagram definitions}
...
/-- The checked result of generating one exact splice candidate. -/
structure RawConcreteSpliceResult
    {definitions : List (List Sig)}
    {base : CheckedDiagram definitions}
    {site : base.val.RegionId}
    {fragment : CheckedOpenDiagram definitions}
...
namespace RawConcreteSpliceResult

/-- The exact checked diagram generated by the splice construction. -/
def checked
    {definitions : List (List Sig)}
    {base : CheckedDiagram definitions}
    {site : base.val.RegionId}
...
end RawConcreteSpliceResult

/-- Validate the exact generated splice table. -/
def spliceRaw
    {definitions : List (List Sig)}
    {base : CheckedDiagram definitions}
    {site : base.val.RegionId}
    {fragment : CheckedOpenDiagram definitions}
    (attachment : ConcreteSpliceAttachment base site fragment) :
    Except WFError (RawConcreteSpliceResult attachment) := by
  match accepted :
  ...
  | .ok checked =>
      ...
      exact .ok
        (RawConcreteSpliceResult.mk (by
          rw [← same]
          exact checked.property))

/-- Successful raw validation certifies the generated splice table. -/
theorem spliceRaw_success_wellFormed
    {definitions : List (List Sig)}
    {base : CheckedDiagram definitions}
    {site : base.val.RegionId}
    {fragment : CheckedOpenDiagram definitions}
...
/-- A successful raw result is definitionally the generated splice diagram. -/
theorem spliceRaw_success_checked
    {definitions : List (List Sig)}
    {base : CheckedDiagram definitions}
    {site : base.val.RegionId}
    {fragment : CheckedOpenDiagram definitions}
    ...
    (accepted : spliceRaw attachment = .ok result) :
    result.checked =
      (⟨attachment.diagram, spliceRaw_success_wellFormed accepted⟩ :
