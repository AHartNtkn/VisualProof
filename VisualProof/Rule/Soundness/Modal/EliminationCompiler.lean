  ...
  | child child =>
      ...
      | bubble actualParent arity =>
          ...
          | some sourceBody =>
              ...
              | none =>
                  simp [ConcreteElaboration.compileOccurrenceWith?,
                    targetKind, targetPushed, targetResult]
                    at targetCompiled
              | some targetBody =>
                  simp [ConcreteElaboration.compileOccurrenceWith?,
                    targetKind, targetPushed, targetResult]
                  ...
                  have targetParentEq :
                    ...
                    simp [targetKind, CRegion.parent?]
                  let pushedWitness :=
                    PromotedBinderWitness.push binderWitness child sourceParent
                      arity
                  have bodies := recurseAt
                  ...
                  have pushedMap :
                    ...
                    simpa only [pushedWitness] using
                      PromotedBinderWitness.relationMap_push binderWitness child
                        sourceParent arity
