import VisualProof.Rule.Completeness.Comprehension.Leaf.AccumulatorFramework
...
authoritative target traversal, so specializations never reconstruct target
witnesses. -/
