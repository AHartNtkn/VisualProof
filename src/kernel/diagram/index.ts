...
export type { ExploreLabeling, DiagramIso, RefinedColors } from './canonical/explore'
export { exploreForm, boundaryForm, exploreLabeling, exploreIso, refinedColors } from './canonical/explore'
